...
static const _PoseEstimate_type_support_symbol_names_t _PoseEstimate_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, t3_interfaces, msg, PoseEstimate)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, t3_interfaces, msg, PoseEstimate)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, t3_interfaces, msg, PoseEstimate)() {
  return &::t3_interfaces::msg::rosidl_typesupport_c::PoseEstimate_message_type_support_handle;
}
