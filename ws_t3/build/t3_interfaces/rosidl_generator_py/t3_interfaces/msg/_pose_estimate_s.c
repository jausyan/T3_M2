...
bool t3_interfaces__msg__pose_estimate__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("t3_interfaces.msg._pose_estimate.PoseEstimate", full_classname_dest, 45) == 0);
  }
  t3_interfaces__msg__PoseEstimate * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of PoseEstimate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("t3_interfaces.msg._pose_estimate");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseEstimate");
